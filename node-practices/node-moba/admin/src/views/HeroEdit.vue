      ...
      <el-tabs type="border-card" value="skills">
        <el-tab-pane label="基本信息" name="basic">
          ...
          <el-form-item label="生存">
            <el-rate :max="9" show-score v-model="model.scores.survival"></el-rate>
          </el-form-item>
          ...
          <el-form-item label="对抗技巧">
            <el-input type="textarea" :rows="2" placeholder="请输入内容" v-model="model.battleTips"></el-input>
          </el-form-item>
        ...
        <el-tab-pane label="技能" name="skills">
          <el-button class="add-skills" type="" @click="model.skills.push({})" style="left: 10px;">
...
export default {
  ...
  methods: {
    ...
    handleUploadSuccess(res) {
      ...
      // 可能无法响应式更新，但也可直接在 data 中标记需要的属性
